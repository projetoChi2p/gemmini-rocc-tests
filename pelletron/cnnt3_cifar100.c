...
#include "includes/cnnt3_cifar100_params.h"
#else
#include "includes/cnnt3_cifar100_quant_params.h"
#endif
...
static elem_t conv3_w_flat[3*3*32][100];
static elem_t layer2_conv3_out[25600];
static elem_t layer3_global_pool_out[100];
...
int main() {
    ...
    flatten_weights(100, 3, 32, (elem_t*)conv3_w, (elem_t*)conv3_w_flat);
    gemmini_flush(0);
...
#endif
        tiled_conv_auto(1, 16, 16, 32, 100, 16, 16, 1, 1, 1, 1, 3, false, false, false, false, false, (elem_t*)layer1_conv2_out, (elem_t*)conv3_w_flat, (acc_t*)conv3_b, (elem_t*)layer2_conv3_out, RELU, (acc_scale_t)CONV3_SCALE, 0, 0, 0, WS);
#if defined(DEBUG) && defined(DEBUG_CONV3_AVAILABLE)
        if (i == 0) {
            verify_array("conv3", 25600, (elem_t*)layer2_conv3_out, (elem_t*)debug_conv3);
        }
#endif
        global_average_pool(1, 16, 16, 100, (elem_t*)layer2_conv3_out, (elem_t*)layer3_global_pool_out);
#if defined(DEBUG) && defined(DEBUG_GLOBAL_POOL_AVAILABLE)
        if (i == 0) {
            verify_array("global_pool", 100, (elem_t*)layer3_global_pool_out, (elem_t*)debug_global_pool);
        }
#endif
