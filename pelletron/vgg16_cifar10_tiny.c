...
#include "includes/vgg16_cifar10_tiny_params.h"
#else
#include "includes/vgg16_cifar10_tiny_quant_params.h"
#endif
...
#endif
        tiled_matmul_auto(1, 10, 32, (elem_t*)layer17_global_pool_out, (elem_t*)classifier_w, (acc_t*)classifier_b, (elem_t*)layer18_classifier_out, 32, 10, 10, 10, MVIN_SCALE_IDENTITY, MVIN_SCALE_IDENTITY, MVIN_SCALE_IDENTITY, NO_ACTIVATION, (acc_scale_t)CLASSIFIER_SCALE, ACC_SCALE_IDENTITY, true, false, false, false, false, 0, WS);
