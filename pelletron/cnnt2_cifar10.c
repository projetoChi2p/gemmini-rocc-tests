...
#include "includes/cnnt2_cifar10_params.h"
#else
#include "includes/cnnt2_cifar10_quant_params.h"
#endif  
...
static elem_t conv4_w_flat[3*3*16][10];
static elem_t layer3_conv4_out[40];
static elem_t layer4_global_pool_out[10];
...
int main() {
    ...
    flatten_weights(10, 3, 16, (elem_t*)conv4_w, (elem_t*)conv4_w_flat);
    gemmini_flush(0);
...
#endif
        tiled_conv_auto(1, 4, 4, 16, 10, 2, 2, 2, 1, 1, 1, 3, false, false, false, false, false, (elem_t*)layer2_conv3_out, (elem_t*)conv4_w_flat, (acc_t*)conv4_b, (elem_t*)layer3_conv4_out, RELU, (acc_scale_t)CONV4_SCALE, 0, 0, 0, WS);
#if defined(DEBUG) && defined(DEBUG_CONV4_AVAILABLE)
        if (i == 0) {
            verify_array("conv4", 40, (elem_t*)layer3_conv4_out, (elem_t*)debug_conv4);
        }
#endif
        global_average_pool(1, 2, 2, 10, (elem_t*)layer3_conv4_out, (elem_t*)layer4_global_pool_out);
#if defined(DEBUG) && defined(DEBUG_GLOBAL_POOL_AVAILABLE)
        if (i == 0) {
            verify_array("global_pool", 10, (elem_t*)layer4_global_pool_out, (elem_t*)debug_global_pool);
        }
#endif
